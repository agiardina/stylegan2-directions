...
if os.path.exists("output"):
    raise SystemExit("The output folder already exists. Remove it before running this script.")
...
def process_image(df, image_number):
    original = "img/{}.jpg".format(image_number)
    ...
    w = np.load("latentspaces/{}_latentspace_restyle.npy".format(image_number))
    if w.shape == (18, 512):
